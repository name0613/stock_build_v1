...
const statusLabel: Record<string, string> = { STRONG_ACCUMULATION: "強勢累積", ACCUMULATION: "累積", WATCH: "觀察", NO_STRONG_EVIDENCE: "尚無強勢證據", DATA_INSUFFICIENT: "資料不足", SCORE_BLOCKED_BY_SOURCE_COVERAGE: "來源覆蓋不足（評分暫停）" };
const operationStatusLabel: Record<string, string> = { SUCCESS: "完成", RUNNING: "執行中", FAILED: "失敗", PARTIAL: "部分完成", REUSED: "已沿用", NO_DATA: "無資料", DEFERRED_BEFORE_SOURCE_PUBLICATION: "等待來源發布", AVAILABLE: "可用", ERROR: "錯誤", FRESH: "最新", CURRENT: "目前", STALE: "過期", PARTIAL_RESPONSE: "部分回應", UNAVAILABLE_NOT_CONFIGURED: "尚未設定" };
