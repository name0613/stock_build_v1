...
Statuses are `RUNNING`, `SUCCESS`, `PARTIAL`, `FAILED`; error codes include `ACCESS_DENIED`, `RATE_LIMITED`, `UPSTREAM_5XX`, `TIMEOUT`, `SCHEMA_MISMATCH` and `RAW_STORAGE_UNAVAILABLE`.
