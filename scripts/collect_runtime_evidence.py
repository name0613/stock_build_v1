...
if __name__ == "__main__":
    ...
    evidence = {"url": base, "health": health, "summary": summary, "data_status": status, "api_timing_ms": {"health": health_ms, "summary": summary_ms, "data_status": status_ms}, "sanitized": True, "secrets_included": False}
